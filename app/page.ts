...
import { createElement as e, useMemo, useState } from "react";
...
function memberSection(activeMember: Member) {
  return e(
    motion.section,
    {
      key: activeMember.id,
    ...
    e(
      ...
      {
        className:
          "rounded-3xl bg-white/80 p-5 shadow-sm transition-transform hover:scale-105 md:p-6",
      },
      e(
        "div",
        {
        ...
        e(
          ...
          {
            className:
              "h-28 w-28 overflow-hidden rounded-full border-4 border-[#B2E2F2] bg-gradient-to-br from-white to-[#FFB7B2]/25",
          },
          e(Image, {
        ...
        e(
          ...
          e("h1", { className: "text-2xl font-bold" }, activeMember.name),
          e(
            "p",
            {
              className:
                "mt-4 rounded-3xl bg-[#FDFD96]/45 px-4 py-3 text-sm italic",
            },
            "\u201c",
            activeMember.quote,
            "\u201d",
    ...
    e(
      ...
      e("h2", { className: "text-lg font-bold" }, "Skills"),
      e(
        "div",
        ...
        ...activeMember.skills.map((skill) =>
          e(
            "span",
            {
              key: skill,
              className:
                "rounded-full bg-[#B2E2F2]/70 px-3 py-1 text-xs font-semibold",
            },
            skill,
          ),
        ),
    ...
    e(
      ...
      e("h2", { className: "text-lg font-bold" }, "About Me"),
      e(
        "div",
        {
          className:
            "mt-4 rounded-3xl border border-white/70 bg-white/80 p-4 shadow-sm",
        },
        e(
          "div",
          ...
          e(
            "p",
            null,
            e("span", { className: "font-bold" }, "Age: "),
            activeMember.aboutMe.age,
          ),
          e(
            "p",
            null,
            e("span", { className: "font-bold" }, "Religion: "),
            " ",
          ...
          e(
            "p",
            null,
            e("span", { className: "font-bold" }, "Birthday: "),
            " ",
          ...
          e(
            "p",
            null,
            e("span", { className: "font-bold" }, "Favorite Food: "),
            " ",
          ...
          e(
            "p",
            null,
            e("span", { className: "font-bold" }, "Favorite Drink: "),
            " ",
          ...
          e(
            "p",
            null,
            e("span", { className: "font-bold" }, "Favorite Music Group: "),
            " ",
          ...
          e(
            "p",
            null,
            e("span", { className: "font-bold" }, "Favorite Song: "),
            " ",
            e(
              "a",
              {
                ...
                className:
                  "font-semibold text-[#2c5a8a] underline decoration-[#2c5a8a] underline-offset-2 transition hover:text-[#4A4E69]",
              },
    ...
    e(
      ...
      e("h2", { className: "text-lg font-bold" }, "Contact"),
      e(
        "div",
        {
          className:
            "mt-4 rounded-3xl border border-white/70 bg-white/80 p-4 text-sm shadow-sm",
        },
        e(
          "p",
          null,
          e("span", { className: "font-bold" }, "Email: "),
          activeMember.email,
        ),
      ),
    ),
...
export default function Home() {
  ...
  return e(
    "div",
    { className: "page-shell min-h-screen text-[#4A4E69]" },
    e(
      "div",
      ...
      e(
        ...
        {
          className:
            "sticky top-0 z-30 border-b border-[#ffffff80] bg-[#B2E2F2]/70 backdrop-blur-md",
        },
        e(
          "nav",
          {
            className:
              "mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-4 py-3 md:px-8",
          },
          e(
            "div",
            {
              className:
                "flex items-center gap-2 rounded-3xl bg-[#FFF9F2]/80 px-3 py-2 shadow-sm",
            },
            e(Image, {
              ...
              height: 36,
              className:
                "rounded-full border-2 border-[#FFB7B2] bg-white object-cover",
            }),
          ),
          e(
            "div",
            {
              className:
                "flex flex-wrap items-center justify-center gap-2 rounded-3xl bg-[#FFF9F2]/80 p-2 shadow-sm",
            },
            ...members.map((member) =>
              e(
                "button",
      ...
      e(
        ...
        {
          className:
            "mx-auto flex w-full max-w-6xl flex-col gap-4 px-4 pb-5 pt-5 md:px-8 md:pb-8 md:pt-6",
        },
        e(AnimatePresence, { mode: "wait" }, memberSection(activeMember)),
      ),
    ),
    e(
      "footer",
      {
        className:
          "border-t border-white/50 bg-white/50 px-4 py-4 text-center backdrop-blur-sm",
      },
      e(
        "div",
        ...
        e(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className:
              "rounded-full bg-white/90 px-3 py-1 shadow-sm transition hover:scale-105 hover:underline",
          },
          "GitHub",
        ),
        e(
